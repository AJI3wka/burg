...
console.log('lot_list.controller start');
...
lot_list.controller = {
    ...
    get_items_list:function(callback){
		...
		if(global_price_data){
        	...
        	lot_list.model.c_data = global_price_data;
			callback()
			return
		}
        ...
        get_json('get', url, {}, function(data) {
        	...
        	lot_list.model.c_data = def_obj;
			if(!if_defined(lot_list.model.c_data)){
				if (!if_defined(global_price_data)) {
					global_price_data = lot_list.model.def_data
					lot_list.model.c_data = lot_list.model.def_data;
				}else{
					lot_list.model.c_data = global_price_data;
				}
			}
