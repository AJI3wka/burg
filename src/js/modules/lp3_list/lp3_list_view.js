...
console.log('lp3_list.view start');
...
lp3_list.view = {
 ...
 //        var $wrap = lp3_list.view.wrap.find('.list').find('.project[data-id="' + id + '"]');
 ...
 //        $stat_wrap.html(stat_carcas)
	...
	refresh_list:function(data){
	    ...
	    var list_html = lp3_list.model.build_list_html(data);
	    
	    $wrap.html(list_html);

	    // for (var i = data.length - 1; i >= 0; i--) {
	    	
	    // 	lp3_list.controller.get_stat_data(data[i].id,function(id,data){

	    // 		lp3_list.view.apend_stat(id,data);

	    // 	});
	    // }

	    lp3_list.events.rebind_list();
